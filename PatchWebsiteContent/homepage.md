# Patch Homepage Copy -- v1.0 Draft
...
**Subhead:**
> We give you the environment to build, research, or start something real — with the peers, mentorship, and resources to do it properly.
...
> Our main entry point. [Learn more →]
...
**Body:**
> Patch's mission is to find and support talented youth from all over Ireland, helping them become the next generation of impactful leaders across science, technology, research, and policy — including social enterprises, environmental work, deeptech, software, hardware, and biotech.

> We do this through running multiple interconnected initiatives, all aimed at taking young people seriously, raising their ambitions, connecting them with energetic peers who they'll form lifelong connections with, and learning directly from Ireland's top founders, experts, and older peers.

**Letter from the Founder:**

[Visual: Letter card with repeating logo grid background and spinning badge]

> **A letter from the team**

> Patch exists to bring exceptional young people into a community that takes them seriously. Talent on its own is fragile — it needs encouragement, peers, and examples of what's possible in order to grow.

> We don't prescribe paths or outcomes. Instead, we create the conditions where ambition is normal, curiosity is valued, and young people are consistently encouraged to aim higher than they might have on their own.

> — Tom McCarthy, Founder of Patch

---

## Section 3: Core Programmes

**Visual note:** Summer Programme card should be **larger/emphasized** — maybe 2x width or positioned prominently

### Summer Programme [EMPHASIZED CARD]

[Photos: Multiple images - team presenting on stage, big group photo, people working on projects]

> Seven weeks. 30 people. The flagship entry point into Patch.

> Teams build startups, research projects, or technology. Everything covered: accommodation, meals, expenses.
...
### TECS
[Photo: TECS competition or students working]
...
### SF Fellowship  
[Photo: Patrick Collison meeting or OpenAI visit]
...
## Section 4: Alumni-Led Initiatives

**Section label:**
> Started by alumni

**Headline:**
> When Patchers see a gap, they fill it

**Body:**
> The strongest signal of Patch working: alumni don't wait for permission. They start things.

**Grid of 4 initiatives (photos + brief description):**

### Hack Ireland
[Photo: hackathon in action]
...
### Eirspace
[Photo: rocket or team]
> Student rocket-building collective. Designing, building, launching.

### Give(a)go
[Photo: workshop]
> Community workshops teaching AI agents, game dev, hardware. Open to everyone.

---

## Section 5: What Alumni Build and Do
...
**Body:**
> Most join at 16-17. What they go on to build and do speaks for itself.

### Companies Founded

**Grid format with photos:**

**Ulysses** — Robots under the ocean  
[Photo: underwater drone/seagrass restoration]
...
**Icarus Robotics** — Robots in space  
[Photo: Times Square ad or team photo]
> Building a robotic labor force for space. Design partnerships with two commercial space station operators and NASA.

**Field of Vision** — Accessibility tech for blind sports fans  
[Photo: Brian O'Driscoll + team, or device photo]
...
**Induct** — Smart access control  
[Photo: team on stage at Web Summit]
...
[Photo: Dylan Cuskelly in Cambridge gowns]
> Pursuing fundamental research at one of the world's top institutions.

**Muscles-on-a-chip research**  
[Photo: lab work or researcher]
> Advanced biotech research at [institution name].

**MIT Research & Science Institute**  
[Photo: researcher or lab setting]
> 3 Patchers selected for MIT's prestigious summer research programme.
...
[Photos of alumni at companies]

**Firefly Aerospace**  
[Photo: Aidan McNeill with rocket behind him]
> Engineer at Firefly Aerospace. Building rockets that go to space.

**Red Bull Racing**  
[Photo: Colm O'Brien or F1 context]
> Aerodynamics Engineer. Formula 1.

**Other companies where alumni work:**  
[Company logos: Stripe, Meta, Optiver, SIG, Centre for Effective Altruism]
> Alumni have gone on to engineering, product, research, and trading roles at leading technology companies and research organizations including Stripe, Meta, Optiver, SIG, and Centre for Effective Altruism.

---

## Section 6: Testimonials (Scattered Throughout Section 5)
...
> — Sam Enright, Progress Ireland cofounder
...
> — Diana Hrisovescu, O'Shaughnessy Ventures Fellow

> "I cofounded my company with two Patchers. Our first employee was a Patcher. When we needed technical advice, we asked Patchers."  
> — [Alumni founder name]
...
**Body:**
> Accommodation. Meals. Expenses. Stipends where needed.

> Thanks to Stripe, OpenAI, Dogpatch Labs, and our other supporters, access is based on potential, not background.

**Partner logos:**  
[Stripe, OpenAI, Dogpatch Labs, NDRC, Abbey Capital, etc.]
...
**Secondary:**
> Know someone who should apply? Share this page.
...
**Newsletter Signup:**
> Stay updated on Patch programmes and events
